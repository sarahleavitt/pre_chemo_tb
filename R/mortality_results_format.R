...
form_sev_us <- formatBayesian(mortality, res_sev_us, data_sev_us, "Severity_nonus", fixed = TRUE)
form_comp_nonus <- formatBayesian(mortality, res_comp_us, data_comp_us, "Combined_nonus")
form_sev_nonus <- formatBayesian(mortality, res_sev_us, data_sev_us, "Severity_us", fixed = TRUE)
...
form_comp_pre <- formatBayesian(mortality, res_comp_post, data_comp_post, "Combined_post")
form_sev_pre <- formatBayesian(mortality, res_sev_post, data_sev_post, "Severity_pre", fixed = TRUE)
