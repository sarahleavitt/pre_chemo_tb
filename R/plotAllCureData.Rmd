...
ggplot(cureData2[cureData2$severity=="None",],aes(x=interval_r,y=cureRate,group=cohort_id,color=cohort_id))+
  geom_point()+geom_line()+xlim(0,10)+ylim(0,1)+
  labs(title="Studies without severity reported",x="Year since diagnosis",y="Probability of Natural Recovery")
```
